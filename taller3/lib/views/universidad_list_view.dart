              ...
              builder: (context, constraints) {
                ...
                final int crossAxisCount = screenWidth > 1200
                    ...
                    : screenWidth > 800
                        ? 2
                        : 1;
                final double padding = screenWidth > 600 ? 28 : 18;
                final double spacing = screenWidth > 600 ? 18 : 12;
                ...
                if (useGrid && crossAxisCount > 1) {
                  listContent = GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      childAspectRatio: screenWidth > 1200 ? 2.6 : 2.3,
                    ),
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: InkWell(
        ...
        child: Padding(
          padding: EdgeInsets.all(isGridView ? 14 : 18),
          child: isGridView
